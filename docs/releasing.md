...
Run **Desktop packages** from `main`. You may supply the planned tag, such as `v1.5.0`, in
...
```powershell
$asset = "CareerOS-Local_1.5.0_windows-x64-setup.exe"
...
gh attestation verify .\CareerOS-Local_1.5.0_windows-x64-setup.exe `
