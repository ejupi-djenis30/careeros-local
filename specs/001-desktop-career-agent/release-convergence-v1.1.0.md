...
| FR-038 exact candidate | `release_assets.py` and `release_contract.py` normalize six targets, reject links/unsafe names/casefold collisions, and bind target/type/name/size/SHA-256, exact checksum names, MIT license, three SBOMs, and deterministic evidence into 22 public assets. | Candidate tamper, collision, duplicate-type, missing/foreign evidence, reproducibility, exact inventory, and checksum tests. | Converged |
