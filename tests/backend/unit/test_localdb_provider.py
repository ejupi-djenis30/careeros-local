...
def test_db_job_to_listing_parsing(local_db_provider):
    ...
    job1 = ScrapedJob(
        platform="x", platform_job_id="1", title="A", external_url="a", workload="100%"
    )
    ...
    job2 = ScrapedJob(
        platform="x", platform_job_id="2", title="B", external_url="b", workload="50-80"
    )
    ...
    job3 = ScrapedJob(
        platform="x", platform_job_id="3", title="C", external_url="c", workload=None, company="Cmp"
    )
