...
def test_repository_release_versions_are_consistent() -> None:
    ...
    assert validate_versions(versions) == "1.10.0"
    assert changelog_release_date("1.10.0", ROOT) == "2026-07-30"
    assert validate_release_date("1.10.0", "2026-07-30", ROOT) == "2026-07-30"
