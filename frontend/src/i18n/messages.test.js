...
const SHARED_COPY_KEYS = new Set([
    ...
    "goal.industriesPlaceholder",
    "goal.rolesPlaceholder",
    "goal.seniorityPlaceholder",
    "jobs.email",
    "login.password",
    "nav.vault",
    "page.home.eyebrow",
    ...
    "preferences.rolesPlaceholder",
    "profile.email",
    "providers.adapterHtml",
    "providers.attributePlaceholder",
    "providers.baseUrlPlaceholder",
    "providers.itemSelectorPlaceholder",
    "providers.methodGet",
    "providers.methodPost",
    "providers.pathPlaceholder",
