    ...
    return {
        ...
        goals: [{
            ...
            payload: {
                ...
                progress_percent: 25,
                success_criteria: ["Ruolo coerente firmato"],
        ...
        analysis: {
            ...
            section_scores: { identity: 100, experience: 100, skills: 75, education: 0, achievements: 0, projects: 0, credentials_activities: 0, preferences: 0, goals: 50 },
            missing_sections: ["education", "achievements", "projects", "credentials_activities", "preferences"],
            evidence: [
                { fact_id: FACT_ID, state: "confirmed", evidence_fact_ids: [] },
                { fact_id: EXPERIENCE_ID, state: "confirmed", evidence_fact_ids: [] },
            ],
            issues: [{ code: "overlapping_primary_employment", severity: "warning", message: "Overlapping employment", fact_ids: [EXPERIENCE_ID], goal_ids: [] }],
        },
        created_at: "2026-01-01T10:00:00Z",
        updated_at: "2026-01-01T10:00:00Z",
        ...overrides,
...
export function resumeDraft(overrides = {}) {
    return {
        ...
        template_kind: "ats",
        section_config: {
            order: ["experience", "education", "project", "skill", "language", "certification", "achievement", "award", "membership", "portfolio", "volunteering", "publication", "link"],
