    ...
    return (
        <div className="resume-studio">
            ...
            <div className="resume-editor">
                ...
                <section className="surface-section"><div className="section-heading"><div><span className="section-kicker">Versioni immutabili</span><h2>Pubblicazioni</h2></div></div><ResumeVersions versions={draft.versions} onError={studio.setError} /></section>
            </div>
