    ...
    return (
        <section className="surface-section" aria-labelledby="preferences-title">
            ...
            <div className="form-grid form-grid--3">
                <ListField label={t("preferences.roles")} value={preferences.target_roles} onChange={(value) => update("target_roles", value)} placeholder={t("preferences.rolesPlaceholder")} />
                <ListField label={t("preferences.industries")} value={preferences.target_industries} onChange={(value) => update("target_industries", value)} placeholder={t("preferences.industriesPlaceholder")} />
                <ListField label={t("preferences.locations")} value={preferences.preferred_locations} onChange={(value) => update("preferred_locations", value)} placeholder={t("preferences.locationsPlaceholder")} />
                ...
                <label className="field-stack"><span>{t("preferences.languages")}</span><input className="form-control" value={(preferences.preferred_languages || []).join(", ")} onChange={(e) => update("preferred_languages", splitList(e.target.value))} placeholder={t("preferences.languagesPlaceholder")} /></label>
