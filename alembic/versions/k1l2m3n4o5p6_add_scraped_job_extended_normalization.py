...
def upgrade() -> None:
    op.add_column('scraped_jobs', sa.Column('normalized_preferred_skills', sa.JSON(), nullable=True))
    op.add_column('scraped_jobs', sa.Column('normalized_soft_skills', sa.JSON(), nullable=True))
    op.add_column('scraped_jobs', sa.Column('normalized_physical_requirements', sa.JSON(), nullable=True))
    op.add_column('scraped_jobs', sa.Column('normalized_entry_barrier', sa.String(), nullable=True))
    op.add_column('scraped_jobs', sa.Column('normalized_career_changer_friendly', sa.Boolean(), nullable=True))
