...
def upgrade() -> None:
    ...
    op.add_column(
        "scraped_jobs", sa.Column("normalized_at", sa.DateTime(timezone=True), nullable=True)
    )
    ...
    op.add_column(
        "scraped_jobs", sa.Column("normalized_employment_mode", sa.String(), nullable=True)
    )
    op.add_column("scraped_jobs", sa.Column("normalized_contract_type", sa.String(), nullable=True))
    op.add_column(
        "scraped_jobs", sa.Column("normalized_qualification_level", sa.String(), nullable=True)
    )
    op.add_column(
        "scraped_jobs", sa.Column("normalized_experience_min_years", sa.Integer(), nullable=True)
    )
    op.add_column(
        "scraped_jobs", sa.Column("normalized_experience_max_years", sa.Integer(), nullable=True)
    )
    ...
    op.add_column(
        "scraped_jobs", sa.Column("normalized_salary_min_chf", sa.Integer(), nullable=True)
    )
    op.add_column(
        "scraped_jobs", sa.Column("normalized_salary_max_chf", sa.Integer(), nullable=True)
    )
    op.add_column(
        "scraped_jobs", sa.Column("normalized_required_languages", sa.JSON(), nullable=True)
    )
    op.add_column("scraped_jobs", sa.Column("normalized_required_skills", sa.JSON(), nullable=True))
    op.add_column(
        "scraped_jobs", sa.Column("normalized_education_levels", sa.JSON(), nullable=True)
    )
    op.add_column(
        "scraped_jobs", sa.Column("normalized_key_requirements", sa.JSON(), nullable=True)
    )
    op.add_column("scraped_jobs", sa.Column("normalized_metadata", sa.JSON(), nullable=True))

    op.create_index(
        op.f("ix_scraped_jobs_normalization_status"),
        "scraped_jobs",
        ["normalization_status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_scraped_jobs_normalized_at"), "scraped_jobs", ["normalized_at"], unique=False
    )
    op.create_index(
        op.f("ix_scraped_jobs_normalized_role_family"),
        "scraped_jobs",
        ["normalized_role_family"],
        unique=False,
    )
    op.create_index(
        op.f("ix_scraped_jobs_normalized_domain"),
        "scraped_jobs",
        ["normalized_domain"],
        unique=False,
    )
    op.create_index(
        op.f("ix_scraped_jobs_normalized_seniority"),
        "scraped_jobs",
        ["normalized_seniority"],
        unique=False,
    )
    op.create_index(
        op.f("ix_scraped_jobs_normalized_employment_mode"),
        "scraped_jobs",
        ["normalized_employment_mode"],
        unique=False,
    )
    op.create_index(
        op.f("ix_scraped_jobs_normalized_contract_type"),
        "scraped_jobs",
        ["normalized_contract_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_scraped_jobs_normalized_qualification_level"),
        "scraped_jobs",
        ["normalized_qualification_level"],
        unique=False,
    )
